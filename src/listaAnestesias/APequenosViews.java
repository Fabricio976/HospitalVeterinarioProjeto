...
import InterfaceGraphic.AnestesiaTableModel;

public class APequenosViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					APequenosViews frame = new APequenosViews();
	...
	AnestesiaTableModel modelTable = new AnestesiaTableModel();
	 ...
	 * Create the frame.
	 */
	public APequenosViews() {	
		JFrame frame = new JFrame("Anestesia");
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Anestesias Pequenos</b></html>"));
		
		JButton btnExcluir = new JButton("Excluir");
		
		JButton btnImprimirAP = new JButton("Imprimir");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(btnImprimirAP, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							...
							.addComponent(btnProcurar))
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							.addComponent(btnImprimirAP, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)

...
public class ASilvestresViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ASilvestresViews frame = new ASilvestresViews();
	...
	public ASilvestresViews() {
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Anestesias Silvestres</b></html>"));
		
		JButton btnExcluir = new JButton("Excluir");
		
		JButton btnImprimirAS = new JButton("Imprimir");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(btnImprimirAS, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							...
							.addComponent(btnProcurar))
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							.addComponent(btnImprimirAS, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)

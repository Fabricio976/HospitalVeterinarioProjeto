...
public class AGrandesViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AGrandesViews frame = new AGrandesViews();
	...
	public AGrandesViews() {
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Anestesia Grandes</b></html>"));
		
		JButton btnExcluir = new JButton("Excluir");
		
		JButton btnImprimirAG = new JButton("Imprimir");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(9)
					.addComponent(btnImprimirAG, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							...
							.addComponent(btnProcurar))
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							.addComponent(btnImprimirAG, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)

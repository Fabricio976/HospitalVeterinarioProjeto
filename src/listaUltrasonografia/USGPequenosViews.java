...
public class USGPequenosViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					USGPequenosViews frame = new USGPequenosViews();
	...
	public USGPequenosViews() {
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Ultrasonografia Pequenos</html></b>"));

...
public class EndoscopiaTableModel extends DefaultTableModel {

	private List<CadastroGeral> linhas = new ArrayList<CadastroGeral>();
	private String[] colunas = {"Data", "RG", "Nome do Animal", "Espécie", "Exames", "Estudos Simples",
			"Estudos Complexos" };
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 5:
			return linhas.get(linha).getExamesEndoscopia();

		case 6:
			return linhas.get(linha).getEstudosESimples();

		case 7:
			return linhas.get(linha).getEstudosEComplexos();

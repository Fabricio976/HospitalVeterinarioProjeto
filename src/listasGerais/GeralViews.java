...
public class GeralViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GeralViews frame = new GeralViews();
	...
	public GeralViews() {
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Geral</b></html>"));

		JButton btnExcluir = new JButton("Excluir");

		JButton btnImprimirG = new JButton("Imprimir");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(9)
					.addComponent(btnImprimirG, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							.addComponent(btnImprimirG, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
		...
		List<CadastroGeral> cadastros = bd.listAll();

		for (CadastroGeral cadastro : cadastros) {
			modelTable.addRow(new Object[] { cadastro.getData(), cadastro.getRg(), cadastro.getNome(), cadastro.getProprietario(),
					cadastro.getEspecie(), cadastro.getSexo(), cadastro.getRaca(), cadastro.getIdade(),
					cadastro.getResponsavel() });
		}

...
import InterfaceGraphic.AtendimentoExtModel;

public class AtendimentosEXT extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AtendimentosEXT frame = new AtendimentosEXT();
	...
	AtendimentoExtModel modelTable = new AtendimentoExtModel();
	...
	public AtendimentosEXT() {
			...
			panel.setBorder(BorderFactory.createTitledBorder("<html><b>Atendimento Externo</b></html>"));
			
			JButton btnExcluir = new JButton("Excluir");
			
			JButton btnImprimirAEX = new JButton("Imprimir");
			...
			gl_contentPane.setHorizontalGroup(
				gl_contentPane.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_contentPane.createSequentialGroup()
						...
						.addComponent(btnImprimirAEX, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.UNRELATED)
					...
					.addGroup(gl_contentPane.createSequentialGroup()
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(btnProcurar))
							.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
								.addComponent(btnImprimirAEX, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)

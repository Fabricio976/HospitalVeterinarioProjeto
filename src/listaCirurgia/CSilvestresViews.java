...
public class CSilvestresViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CSilvestresViews frame = new CSilvestresViews();
	...
	public CSilvestresViews() {
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Cirgurgia Silvestres</b></html>"));

...
public class CGrandesViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CGrandesViews frame = new CGrandesViews();
	...
	CirurgiaTableModel modelTable = new CirurgiaTableModel();
	...
	public CGrandesViews() {
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Cirgurgia Grandes</b></html>"));
		
		JButton btnExcluir = new JButton("Excluir");
		
		JButton btnImprimirCG = new JButton("Imprimir");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(btnImprimirCG, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							...
							.addComponent(btnProcurar))
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							.addComponent(btnImprimirCG, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)

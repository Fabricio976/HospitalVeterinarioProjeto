...
public class CPequenosViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CPequenosViews frame = new CPequenosViews();
	...
	public CPequenosViews() {
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Cirgurgia Pequenos</b></html>"));
		...
		JButton btnProcuruar = new JButton("Procuruar");

...
import InterfaceGraphic.EndoscopiaTableModel;

public class ESilvestresViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ESilvestresViews frame = new ESilvestresViews();
	...
	EndoscopiaTableModel modelTable = new EndoscopiaTableModel();
	...
	public ESilvestresViews() {
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Endoscopia Silvestres</b></html>"));
		
		JButton btnExcluir = new JButton("Excluir");
		
		JButton btnImprimirES = new JButton("Imprimir");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(btnImprimirES, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							...
							.addComponent(btnProcurar))
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							.addComponent(btnImprimirES, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)

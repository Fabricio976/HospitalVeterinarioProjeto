...
public class EGrandesViews extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EGrandesViews frame = new EGrandesViews();
	...
	public EGrandesViews() {
		...
		panel.setBorder(BorderFactory.createTitledBorder("<html><b>Endoscopia Grandes</b></html>"));
		
		JButton btnExcluir = new JButton("Excluir");
		
		JButton btnImprimirEG = new JButton("Imprimir");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(9)
					.addComponent(btnImprimirEG, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							...
							.addComponent(btnProcurar))
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
							.addComponent(btnImprimirEG, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
